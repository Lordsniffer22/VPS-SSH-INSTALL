...
echo -e "\033[1;32m $(fun_trans  "              SSL INSTALLER By BLAKE ")"
msg -bar
...
msg -bar
msg -tit
echo -e "\033[1;93m      SSL + PYDIRECT  \033[1;94m By @tariusblake1"
msg -bar
...
msg -bar
 ...
 sleep 3  
 screen -dmS pydic-80 python ${SCPinst}/python.py 80 "VPS-BLAKE" && echo "80 VPS-BLAKE" >> /etc/VPS-AGN/PySSL.log
 msg -bar
 } 
 install_ssl(){  
...
msg -bar3
msg -tit
echo -e "${cor[3]}       MONO AND MULTI SSL INSTALLER By @tariusblake1"
msg -bar
