...
v1=$(curl -sSL "https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/SCRIPT-v8.5x/Version")
...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/installer/install-without-key.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
...
clear && clear
msg -bar2
echo -e " \e[5m\033[1;100m   =====>> ►► 🐲 Evil_Blake- VPS-script  🐲 ◄◄ <<=====   \033[1;37m"
msg -bar2
print_center -ama "AVAILABLE SCRIPT LIST"
msg -bar
#-BASH SOPORTE ONLINE
wget https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/LINKS-LIBRARIES/SPR.sh -O /usr/bin/SPR >/dev/null 2>&1
chmod +x /usr/bin/SPR
...
install_official() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/SCRIPT-v8.5x/VPS-AGN.tar.xz >/dev/null 2>&1
  ...
  wget https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/LINKS-LIBRARIES/monitor.sh -P /bin/
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/LINKS-LIBRARIES/resetsshdrop &>/dev/null
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/SCRIPT-v8.5x/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/SCRIPT-v8.5x/Version &>/dev/null
  ...
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/Lordsniffer22/VPS-SSH-INSTALL/main/SCRIPT-v8.5x/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
  ...
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[97mTO DISPLAY BASH PANEL TYPE:  menu "' >>.bashrc
  echo 'echo ""' >>.bashrc
